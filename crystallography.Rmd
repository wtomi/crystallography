...
Zgodnoœæ miêdzy atrybutami *local_res_atom_non_h_count* oraz *dict_atom_non_h_count* zasta³a obliczona przy u¿yciu testu Wilcoxsona.
...
Na wykresie widaæ, ¿e istnieje korelacja miêszy wieloma atrybutami.

#Regresja

Na potrzeby regresji zostana usuniête kolumny, które s¹ ze sob¹ parami skorelowane, tak aby zota³o po jednej kolumnie z takich par.
...
Dla atomów RMSE: `r rmse_atom` oraz R^2 `r r2_atom`  

Dla elektronów RMSE: `r rmse_electron` oraz R^2 `r r2_electron`

#Rozk³ad atrybutów part_01
